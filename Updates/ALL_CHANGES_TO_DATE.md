...
Current version: `26.1.0.29-beta`
...
- Preserved the complete `26.1.0.27-beta` source, executable, and update history.
...
- PulseMute Beta now uses the corrected `#A02A39` circular muted-microphone identity everywhere and retains the red/green state-aware microphone control.
- Preserved `26.1.0.28-beta` as a complete rollback release.
- Organized the active Beta for VS Code and Visual Studio editing with a concise file guide.
- Renamed active custom controls under the PulseMute identity and removed obsolete origin wording from active documentation.
- Kept Stable separate and unchanged while Beta moved to `26.1.0.29-beta`.
