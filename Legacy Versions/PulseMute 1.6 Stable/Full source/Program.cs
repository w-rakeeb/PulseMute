    ...
    internal sealed class MainForm : Form
    {
        ...
        private void ShowSettingsV15()
        {
            using (Form dialog = new Form())
            {
                ...
                dialog.ClientSize = new Size(420, 498);
                ...
                Label microphoneLabel = CreateSettingsLabel("Microphone", 20, 361);
                ...
                microphoneBox.SetBounds(20, 386, 380, 30);
                ...
                Button soundSettingsButton = CreateSmallButton("Sound settings", new Point(20, 424));
                ...
                Button doneButton = CreateSmallButton("Done", new Point(326, 424));
                doneButton.Size = new Size(74, 28);
                doneButton.Click += delegate { dialog.Close(); };
                dialog.AcceptButton = doneButton;

                Panel footerSeparator = CreateSeparator(20, 462, 380);
                versionLabel.SetBounds(20, 469, 380, 18);
                ...
                Action applyDialogTheme = delegate
                {
                    ...
                    foreach (Label label in new Label[] { heading, autoLabel, taskbarLabel, rememberLabel, appearanceLabel, customizationLabel, microphoneLabel })
                        label.ForeColor = foreground;
                    versionLabel.ForeColor = secondary;

                    foreach (Label state in new Label[] { autoState, taskbarState, rememberState, appearanceState, customizationState })
                    ...
                    foreach (Button button in new Button[] { customizeButton, soundSettingsButton, doneButton })
                    {
