...
Version 1.5 refines PulseMute with professional settings controls, consistent Fluent action icons, a redesigned hotkey row, and corrected always-on-top Settings behavior.
