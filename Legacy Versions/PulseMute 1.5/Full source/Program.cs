    ...
    internal sealed class MainForm : Form
    {
        ...
        private void ShowSettingsV15()
        {
            using (Form dialog = new Form())
            {
                ...
                Label microphoneLabel = CreateSettingsLabel("Microphone", 20, 307);
                ...
                microphoneBox.SetBounds(20, 332, 380, 30);
                ...
                Button soundSettingsButton = CreateSmallButton("Sound settings", new Point(20, 368));
                ...
                Button doneButton = CreateSmallButton("Done", new Point(326, 368));
                ...
                Action applyDialogTheme = delegate
                {
                    ...
                    foreach (Label state in new Label[] { autoState, taskbarState, rememberState, appearanceState })
