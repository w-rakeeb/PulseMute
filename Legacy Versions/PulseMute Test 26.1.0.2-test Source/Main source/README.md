...
PulseMute Test 26.1.0.2-test is the experimental channel for brand-new features and testing.
...
- Global Mouse 1 through Mouse 5 hotkeys.
- Vertical and horizontal mouse-wheel direction hotkeys.
- Keyboard, PlayStation, and mouse inputs can be mixed between both slots.
...
- `test-controller.ps1` runs keyboard-slot, mouse, controller protocol, and read-only hardware checks.
