    ...
    internal sealed class MainForm : Form
    {
        ...
        private void ShowSettings()
        {
            using (Form dialog = new Form())
            {
                ...
                dialog.ClientSize = new Size(360, 205);
                ...
                microphoneLabel.SetBounds(20, 103, 320, 24);
                ...
                microphoneBox.SetBounds(20, 129, 320, 30);
                ...
                Button closeButton = CreateSmallButton("Close", new Point(266, 169));
