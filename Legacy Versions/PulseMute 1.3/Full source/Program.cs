...
namespace PulseMute
{
    ...
    internal sealed class MainForm : Form
    {
        ...
        private static void ApplyDarkCaption(IntPtr windowHandle)
        {
            int enabled = 1;
            DwmSetWindowAttribute(windowHandle, 20, ref enabled, sizeof(int));
            DwmSetWindowAttribute(windowHandle, 19, ref enabled, sizeof(int));

            int captionColor = ColorRef(Color.FromArgb(17, 20, 24));
            int borderColor = ColorRef(Color.FromArgb(17, 20, 24));
            int textColor = ColorRef(Color.White);
        ...
        private void ShowSettings()
        {
            using (Form dialog = new Form())
            {
                ...
                dialog.ClientSize = new Size(360, 248);
                ...
                dialog.HandleCreated += delegate { ApplyDarkCaption(dialog.Handle); };
                ...
                autoToggle.SetBounds(266, 59, 74, 30);
                ...
                taskbarToggle.SetBounds(266, 100, 74, 30);
                ...
                microphoneLabel.SetBounds(20, 144, 320, 24);
                ...
                microphoneBox.SetBounds(20, 170, 320, 30);
                ...
                Button closeButton = CreateSmallButton("Close", new Point(266, 210));
                ...
                taskbarToggle.CheckedChanged += delegate
                {
                    ...
                    taskbarToggle.Text = hideFromTaskbar ? "On" : "Off";
                    taskbarToggle.BackColor = hideFromTaskbar ? Color.FromArgb(26, 124, 88) : Color.FromArgb(31, 36, 43);
        ...
        private void ApplyResponsiveLayout()
        {
            ...
            SetControlFont(settingsButton, "Segoe UI Symbol", 12f * scale, FontStyle.Regular);
            ...
            SetControlFont(creditLabel, "Segoe UI Semibold", 7.8f * scale, FontStyle.Bold);
