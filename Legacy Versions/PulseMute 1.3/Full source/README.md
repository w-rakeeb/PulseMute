...
Version 1.3 adds a matching dark Windows title bar, a refined owner credit, and an option to hide the visible window from the taskbar while keeping it open and available in the tray.
