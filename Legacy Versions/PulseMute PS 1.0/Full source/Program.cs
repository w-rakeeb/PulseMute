    ...
    internal sealed class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            shortcutButton.Click += delegate
            {
                ...
                shortcutValueLabel.Text = "Press key / PS";
        ...
        private void ShowSettingsV15()
        {
            ...
            {
                dialog.Text = "PulseMute PS settings";
        ...
        private void RefreshState()
        {
            try
            {
                ...
                tray.Icon = appIcon;
                tray.Text = muted ? "PulseMute PS - muted" : "PulseMute PS - live";
            }
            catch (Exception ex)
            {
                ...
                tray.Icon = appIcon;
                tray.Text = "PulseMute PS - microphone unavailable";
            }
        }
        ...
        private void HideToTray()
        {
            ...
            tray.ShowBalloonTip(900, "PulseMute PS", "Still listening for " + CurrentShortcutText() + ".", ToolTipIcon.Info);
        }
        ...
        private void DualSenseButtonPressed(object sender, DualSenseButtonEventArgs e)
        {
            ...
            try
            {
                BeginInvoke((MethodInvoker)delegate
                {
                    ...
                    if (shortcutSource == ShortcutSource.DualSense && currentControllerButton == e.Button)
                        ToggleMute();
                });
            }
        ...
        private static bool IsAutoStartEnabled()
        {
            ...
            {
                return key != null && key.GetValue("PulseMutePSAutoStart") != null;
            }
        }
        ...
        private static void SetAutoStartEnabled(bool enabled)
        {
            using (RegistryKey key = Registry.CurrentUser.CreateSubKey(@"Software\Microsoft\Windows\CurrentVersion\Run"))
            {
                ...
                if (enabled)
                    key.SetValue("PulseMutePSAutoStart", "\"" + Application.ExecutablePath + "\"");
                else
                    key.DeleteValue("PulseMutePSAutoStart", false);
            }
        }

        private static string ConfigPath()
        {
            return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "PulseMute", "PS 1.0", "settings.txt");
        }
        ...
        private string CurrentShortcutText()
        {
        ...
        {
            if (nCode >= 0 && !captureNextShortcut && shortcutSource == ShortcutSource.Keyboard)
            {
