...
PulseMute PS 1.0 adds full one-button PlayStation DualSense and DualSense Edge shortcut support.
...
1. Open `PulseMute PS 1.0.exe`.
2. Click the large button to mute or unmute.
3. Click the hotkey edit icon, then press one keyboard key or one DualSense button.
4. Press the assigned input from anywhere to toggle the microphone.
5. Open Settings to view the controller connection or manually rescan it.
