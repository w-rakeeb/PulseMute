...
Version 1.4 adds window-placement control, Dark and White appearance modes, direct access to Windows Sound settings, and sharper responsive text rendering.
