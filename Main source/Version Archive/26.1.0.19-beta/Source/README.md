...
PulseMute Beta 26.1.0.19-beta is the active development and validation channel.
...
- Five selectable mute-control visuals: Classic circle, Microphone tile, Wave badge, Record button, and Power ring.
