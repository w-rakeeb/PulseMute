    ...
    internal sealed partial class MainForm
    {
        private void ShowSettingsV15()
        {
            using (Form dialog = new Form())
            {
                ...
                Button soundSettingsButton = CreateSmallButton("Windows sound settings", new Point(28, 330));
                ...
                Panel developerContent = new Panel();
                developerContent.SetBounds(28, 166, 510, 228);
                developerContent.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;

                Label olderVersionLabel = AddPageLabel(developerContent, primaryLabels, "Older version", 0, 0);
                ThemedComboBox olderVersionBox = CreatePageComboBox(0, 28, 382);
                ...
                Button openVersionButton = CreateSmallButton("Open", new Point(392, 28));
                ...
                Label versionsInfoLabel = AddPageLabel(developerContent, primaryLabels, "Versions info", 0, 80);
                Label versionInfoText = new Label();
                versionInfoText.AutoSize = false;
                versionInfoText.SetBounds(0, 108, 510, 74);
                ...
                aboutVersion.Text = "Version 26.1.0.6-beta";
                ...
                sidebarVersion.Text = "26.1.0.6-beta";
                ...
                Action<string> showPage = delegate(string pageName)
                {
                    ...
                    foreach (KeyValuePair<string, Panel> page in pages)
                        page.Value.Visible = string.Equals(page.Key, activePage, StringComparison.OrdinalIgnoreCase);
