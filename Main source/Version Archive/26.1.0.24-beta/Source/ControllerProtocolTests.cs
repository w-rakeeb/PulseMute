...
namespace PulseMute
{
    internal static class ControllerProtocolTests
    {
        ...
        private static void TestInstanceIsolation()
        {
            ...
            string previousReleaseConfig = MainForm.ConfigPathForRelease(betaPath, appData, "Beta", "26.1.0.23-beta");
            string currentReleaseConfig = MainForm.ConfigPathForRelease(betaPath, appData, "Beta", "26.1.0.24-beta");
            ...
            Assert(MainForm.ReleaseSettingsIdentity().IndexOf("Beta-26_1_0_24-beta", StringComparison.OrdinalIgnoreCase) >= 0, "Current Beta release identity is invalid.");
        }
        ...
        private static void TestArchivedVersionDiscovery()
        {
            ...
            Assert(versions.Count >= 33, "Expected the Beta snapshots and legacy releases in the version picker.");
        ...
        private static void TestNativeSettingsDesign()
        {
            ...
            Assert(source.IndexOf("26.1.0.24-beta", StringComparison.Ordinal) >= 0, "Settings version label is stale.");
