...
PulseMute Beta 26.1.0.14-beta is the active development and validation channel.
...
- Compact hotkey cards inside the bottom icon toolbar with a Developer show/hide option.
- Per-executable settings and auto-start identity to prevent copied versions from sharing configuration.
