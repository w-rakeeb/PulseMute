    ...
    internal sealed partial class MainForm
    {
        private void ShowSettingsV15()
        {
            using (Form dialog = new BufferedSettingsForm())
            {
                ...
                titleBrand.SetBounds(44, 3, 140, 30);
                ...
                versionLabel.SetBounds(16, 10, 290, 18);
                ...
                aboutVersion.Text = "Version 26.1.0.17-beta";
        ...
        private static Panel CreateSidebarSettingsPage(string title, List<Label> primaryLabels)
        {
            ...
            heading.SetBounds(22, 16, 540, 34);
        ...
        {
            Panel separator = CreateSeparator(22, y, 540);
            ...
            params Control[] controls)
        {
            ...
            card.SetBounds(22, y, 540, height);
