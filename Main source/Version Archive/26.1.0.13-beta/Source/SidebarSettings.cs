    ...
    internal sealed partial class MainForm
    {
        private void ShowSettingsV15()
        {
            using (Form dialog = new BufferedSettingsForm())
            {
                ...
                Label hotkeyStripLabel = AddPageLabel(developerContent, primaryLabels, "Show hotkey strip", 0, 86);
                Label hotkeyStripState = AddPageState(developerContent, stateLabels, 0, 108);
                ToggleSwitch hotkeyStripToggle = AddPageToggle(developerContent, toggles, 464, 92, showHotkeyStrip);
                ...
                aboutVersion.Text = "Version 26.1.0.13-beta";
                ...
                sidebarVersion.Text = "26.1.0.13-beta";
