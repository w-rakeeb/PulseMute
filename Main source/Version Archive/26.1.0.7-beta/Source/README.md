...
PulseMute Beta 26.1.0.7-beta is the active development and validation channel.
...
- Slightly rounded controls, with a Developer option to restore square corners.
...
- Developer logo selector with the current logo and an optional professional preview.
