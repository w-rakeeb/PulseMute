...
namespace PulseMute
{
    ...
    internal sealed partial class MainForm : Form
    {
        ...
        private readonly Icon defaultAppIcon;
        private readonly Icon professionalAppIcon;
        ...
        private bool roundedControlsEnabled = true;
        private string logoStyle = "Current";
        ...
        public MainForm()
        {
            ...
            defaultAppIcon = LoadAppIcon();
            professionalAppIcon = LoadEmbeddedIcon("PulseMuteProfessional.ico") ?? defaultAppIcon;
        ...
        private void ApplySelectedLogo()
        {
            appIcon = string.Equals(logoStyle, "Professional", StringComparison.OrdinalIgnoreCase)
                ? professionalAppIcon
                : defaultAppIcon;
            Icon = appIcon;
            if (tray != null)
        ...
        private void ShowSettingsV15Legacy()
        {
            using (Form dialog = new Form())
            {
                ...
                Label olderVersionLabel = CreateSettingsLabel("Older version", 20, 840);
                ...
                olderVersionBox.SetBounds(20, 864, 238, 30);
                ...
                Button openVersionButton = CreateSmallButton("Open", new Point(268, 864));
                openVersionButton.Size = new Size(100, 30);

                Label versionsInfoLabel = CreateSettingsLabel("Versions info", 20, 908);
                Label versionInfoText = new Label();
                versionInfoText.AutoSize = false;
                versionInfoText.SetBounds(20, 932, 348, 50);
                ...
                Action applyDialogTheme = delegate
                {
                    ...
                    foreach (Label label in new Label[] { heading, autoLabel, taskbarLabel, rememberLabel, dualHotkeyLabel, appearanceLabel, customizationLabel, controllerLabel, microphoneLabel, soundFeedbackLabel, soundPresetLabel, developerHeading, developerModeLabel, olderVersionLabel, versionsInfoLabel })
                        label.ForeColor = foreground;
                    versionLabel.ForeColor = secondary;

                    foreach (Label state in new Label[] { autoState, taskbarState, rememberState, dualHotkeyState, appearanceState, customizationState, controllerState, soundFeedbackState, developerModeState })
                    ...
                    foreach (ToggleSwitch toggle in new ToggleSwitch[] { autoToggle, taskbarToggle, rememberToggle, dualHotkeyToggle, appearanceToggle, soundFeedbackToggle, developerModeToggle })
                    {
                    ...
                    foreach (Button button in new Button[] { customizeButton, controllerScanButton, soundSettingsButton, openVersionButton, doneButton })
                    {
                ...
                {
                    heading, autoLabel, autoState, autoToggle, separatorOne,
        ...
        private static string EditionVersionText()
        {
            ...
            return "PulseMute Beta 26.1.0.7-beta";
        }
        ...
        private void ApplyResponsiveLayout()
        {
            ...
            SetControlFont(shortcutTwoValueLabel, "Segoe UI Semibold", 9f * fontScale, FontStyle.Bold);
        ...
        private void SaveShortcut()
        {
            ...
            else
            {
                ...
                File.WriteAllText(path,
                    ...
                    "RoundedControlsEnabled=" + roundedControlsEnabled + Environment.NewLine +
        ...
        private void LoadWindowSettings()
        {
            ...
            try
            {
                ...
                foreach (string line in lines)
                {
                    ...
                    else if (line.StartsWith("RoundedControlsEnabled=", StringComparison.OrdinalIgnoreCase))
                    {
                        bool.TryParse(line.Substring("RoundedControlsEnabled=".Length), out roundedControlsEnabled);
                    }
                    else if (line.StartsWith("LogoStyle=", StringComparison.OrdinalIgnoreCase))
                    {
                        logoStyle = line.Substring("LogoStyle=".Length);
                    }
                ...
                if (!string.Equals(logoStyle, "Professional", StringComparison.OrdinalIgnoreCase))
                    logoStyle = "Current";
        ...
        private static bool IsAutoStartEnabled()
        {
            ...
            {
                return key != null && key.GetValue("PulseMuteBetaAutoStart") != null;
            }
        }
        ...
        private static void SetAutoStartEnabled(bool enabled)
        {
            using (RegistryKey key = Registry.CurrentUser.CreateSubKey(@"Software\Microsoft\Windows\CurrentVersion\Run"))
            {
                ...
                if (enabled)
                    key.SetValue("PulseMuteBetaAutoStart", "\"" + Application.ExecutablePath + "\"");
                else
                    key.DeleteValue("PulseMuteBetaAutoStart", false);
            }
        }

        private static string ConfigPath()
        {
            return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "PulseMute", "Beta", "settings.txt");
        }
