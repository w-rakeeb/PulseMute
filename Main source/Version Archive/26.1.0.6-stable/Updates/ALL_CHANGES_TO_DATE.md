...
Current version: `26.1.0.6-stable`
...
- PulseMute Main now contains the complete promoted Beta feature set, defaults to Rounded square branding and Red/green mic, and retains Stable-specific identity and clean settings.
