...
PulseMute Beta 26.1.0.5-beta is the active development and validation channel.
...
- Four built-in sound styles: Soft Chime, Digital, Click, and Pulse.
- Sound feedback and the selected style are remembered between launches.
...
- Smaller scrollable settings window with a fixed version footer.
