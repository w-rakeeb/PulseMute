...
namespace PulseMute
{
    internal static class ControllerProtocolTests
    {
        ...
        private static void TestArchivedVersionDiscovery()
        {
            ...
            Assert(versions.Count >= 24, "Expected the Beta snapshots and legacy releases in the version picker.");
        ...
        private static void TestNativeSettingsDesign()
        {
            ...
            Assert(source.IndexOf("26.1.0.15-beta", StringComparison.Ordinal) >= 0, "Settings version label is stale.");
