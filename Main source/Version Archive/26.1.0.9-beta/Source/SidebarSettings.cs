    ...
    internal sealed partial class MainForm
    {
        private void ShowSettingsV15()
        {
            using (Form dialog = new BufferedSettingsForm())
            {
                ...
                aboutVersion.Text = "Version 26.1.0.9-beta";
                ...
                sidebarVersion.Text = "26.1.0.9-beta";
                ...
                applyDialogTheme = delegate
                {
                    ...
                    Color border = darkMode ? Color.FromArgb(61, 57, 60) : Color.FromArgb(215, 211, 214);
                    Color sidebarColor = darkMode ? Color.FromArgb(32, 30, 31) : Color.FromArgb(242, 240, 242);
                    if (darkMode && !customColorsEnabled)
                    {
                        background = Color.FromArgb(25, 23, 24);
                        surface = Color.FromArgb(39, 36, 38);
                        foreground = Color.FromArgb(245, 243, 245);
                        secondary = Color.FromArgb(179, 175, 179);
                    }
                    Color accent = customColorsEnabled ? AccentColor() : Color.FromArgb(193, 53, 69);
