...
PulseMute Main 26.1.0.4-stable is the stable daily-use channel.
...
- Optional mute/unmute sound feedback with nine selectable styles and volume control.
...
- Responsive sidebar Settings with General, Hotkeys, Audio, Controller, Customization, Developer, and About pages.
- Optional legacy Settings interface; the sidebar interface is the default.
- Subtle page and toggle animations with a Developer disable switch.
