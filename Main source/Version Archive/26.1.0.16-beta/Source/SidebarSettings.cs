    ...
    internal sealed partial class MainForm
    {
        private void ShowSettingsV15()
        {
            using (Form dialog = new BufferedSettingsForm())
            {
                ...
                dialog.Icon = appIcon;
                dialog.ClientSize = new Size(680, 520);
                ...
                titleLogo.SetBounds(16, 8, 24, 24);
                ...
                titleBrand.SetBounds(48, 5, 160, 30);
                ...
                closeWindowButton.SetBounds(636, 5, 34, 30);
                ...
                sidebar.SetBounds(0, 40, 200, 480);
                ...
                brandLabel.SetBounds(18, 12, 164, 24);
                brandLabel.Text = "SETTINGS";

                Panel contentHost = new BufferedPanel();
                contentHost.SetBounds(200, 40, 480, 436);
                ...
                footer.SetBounds(200, 476, 480, 44);
                ...
                versionLabel.SetBounds(18, 12, 330, 18);
                versionLabel.Anchor = AnchorStyles.Left | AnchorStyles.Bottom;

                Button doneButton = CreateSilenceActionButton("Done", new Point(382, 7));
                ...
                aboutVersion.Text = "Version 26.1.0.16-beta";
