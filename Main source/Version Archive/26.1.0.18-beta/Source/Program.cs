...
namespace PulseMute
{
    ...
    internal sealed partial class MainForm : Form
    {
        ...
        private const string ReleaseVersion = "26.1.0.18-beta";
    ...
    internal sealed class RoundButton : Button
    {
        ...
        private GraphicsPath CreateShapePath(Rectangle bounds)
        {
            ...
            if (VisualStyle == 3)
            {
                ...
                path.AddLine(center, bounds.Top, bounds.Right - bounds.Width * 0.12F, bounds.Top + bounds.Height * 0.16F);
                path.AddLine(bounds.Right - bounds.Width * 0.12F, bounds.Top + bounds.Height * 0.16F, bounds.Right - bounds.Width * 0.2F, bounds.Bottom - bounds.Height * 0.24F);
                path.AddBezier(
                    bounds.Right - bounds.Width * 0.2F, bounds.Bottom - bounds.Height * 0.24F,
                    bounds.Right - bounds.Width * 0.3F, bounds.Bottom - bounds.Height * 0.08F,
                    center + bounds.Width * 0.08F, bounds.Bottom,
                    center, bounds.Bottom);
                path.AddBezier(
                    center, bounds.Bottom,
                    center - bounds.Width * 0.08F, bounds.Bottom,
                    bounds.Left + bounds.Width * 0.3F, bounds.Bottom - bounds.Height * 0.08F,
                    bounds.Left + bounds.Width * 0.2F, bounds.Bottom - bounds.Height * 0.24F);
                path.AddLine(bounds.Left + bounds.Width * 0.2F, bounds.Bottom - bounds.Height * 0.24F, bounds.Left + bounds.Width * 0.12F, bounds.Top + bounds.Height * 0.16F);
                path.CloseFigure();
                return path;
            }
            ...
            if (VisualStyle == 4)
            {
                path.AddPolygon(new PointF[]
                {
                    ...
                    new PointF(bounds.Right - bounds.Width * 0.25F, bounds.Top),
                    new PointF(bounds.Right, bounds.Top + bounds.Height * 0.28F),
                    new PointF(bounds.Right - bounds.Width * 0.08F, bounds.Bottom - bounds.Height * 0.18F),
                    new PointF(bounds.Left + bounds.Width * 0.08F, bounds.Bottom - bounds.Height * 0.18F),
                    new PointF(bounds.Left, bounds.Top + bounds.Height * 0.28F)
                });
                path.CloseFigure();
                return path;
            }
            ...
            int radius = VisualStyle == 1
                ? Math.Max(10, Math.Min(bounds.Width, bounds.Height) / 5)
                : ShapeStyle == 1 ? Math.Max(8, bounds.Height / 2) : Math.Max(8, Math.Min(bounds.Width, bounds.Height) / 7);
        ...
        private void DrawVisualGlyph(Graphics graphics, int style, bool muted)
        {
            ...
            using (SolidBrush brush = new SolidBrush(ForeColor))
            {
                ...
                {
                    graphics.FillEllipse(brush, centerX - 3F * unit, centerY + 9F * unit, 6F * unit, 6F * unit);
                    graphics.DrawArc(pen, centerX - 15F * unit, centerY - 3F * unit, 30F * unit, 30F * unit, 205, 130);
                    graphics.DrawArc(pen, centerX - 25F * unit, centerY - 13F * unit, 50F * unit, 50F * unit, 210, 120);
                }
                else
                {
