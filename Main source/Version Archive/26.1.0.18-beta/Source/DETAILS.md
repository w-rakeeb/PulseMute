...
- Uses a denser `600 x 460` minimal Settings shell with a `164 px` sidebar.
- Keeps full card titles and descriptions readable across compact and DPI-scaled layouts.
- Uses a sharp embedded 256 px logo in About and removes the redundant sidebar version.
- Offers Classic circle, Microphone tile, Wave badge, Shield mic, and Signal hex mute controls.
