    ...
    internal sealed partial class MainForm
    {
        private void ShowSettingsV15()
        {
            using (Form dialog = new BufferedSettingsForm())
            {
                ...
                dialog.Icon = appIcon;
                dialog.ClientSize = new Size(600, 460);
                dialog.MinimumSize = new Size(560, 420);
                ...
                dialog.Font = SettingsBodyFont(9.2F, FontStyle.Regular);
                ...
                closeWindowButton.SetBounds(558, 3, 32, 30);
                ...
                footer.SetBounds(164, 420, 436, 40);
                ...
                versionLabel.SetBounds(16, 10, 312, 18);
                versionLabel.Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Bottom;

                Button doneButton = CreateSilenceActionButton("Done", new Point(344, 5));
                ...
                Panel footerSeparator = CreateSeparator(0, 0, 436);
                ...
                string[] muteDesigns = { "Classic circle", "Microphone tile", "Wave badge", "Shield mic", "Signal hex" };
                ...
                developerContent.SetBounds(28, 166, 510, 374);
                ...
                Label hotkeyStripLabel = AddPageLabel(developerContent, primaryLabels, "Hotkey strip position", 0, 86);
                Label hotkeyStripState = AddPageState(developerContent, stateLabels, 0, 108);
                ToggleSwitch hotkeyStripToggle = AddPageToggle(developerContent, toggles, 464, 92, hotkeyStripAboveCredit);

                Panel developerHotkeySeparator = CreateSeparator(0, 150, 510);
                developerHotkeySeparator.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
                developerContent.Controls.Add(developerHotkeySeparator);
                separators.Add(developerHotkeySeparator);

                Label olderVersionLabel = AddPageLabel(developerContent, primaryLabels, "Older version", 0, 172);
                SilenceComboBox olderVersionBox = CreatePageComboBox(0, 200, 382);
                ...
                Button openVersionButton = CreateSilenceActionButton("Open", new Point(392, 200));
                ...
                Label versionsInfoLabel = AddPageLabel(developerContent, primaryLabels, "Versions info", 0, 252);
                Label versionInfoText = new Label();
                versionInfoText.AutoSize = false;
                versionInfoText.SetBounds(0, 280, 510, 74);
                ...
                developerPage.AutoScrollMinSize = new Size(0, 560);
                ...
                appLogo.Image = CreateHighQualityLogoBitmap();
                ...
                aboutVersion.Text = "Version 26.1.0.18-beta";
                ...
                applyDialogTheme = delegate
                {
                    ...
                    developerPage.AutoScrollMinSize = developerModeToggle.Checked ? new Size(0, 560) : new Size(0, 410);
        ...
        private static Panel CreateSidebarSettingsPage(string title, List<Label> primaryLabels)
        {
            ...
            heading.SetBounds(22, 16, 392, 34);
        ...
        private static Label AddPageLabel(Panel page, List<Label> labels, string text, int x, int y)
        {
            ...
            label.Font = SettingsBodyFont(9F, FontStyle.Bold);
        ...
        private static Label AddPageState(Panel page, List<Label> labels, int x, int y)
        {
            ...
            label.Font = SettingsBodyFont(7.5F, FontStyle.Regular);
            label.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
            page.Controls.Add(label);
            labels.Add(label);
            return label;
        ...
        {
            Panel separator = CreateSeparator(22, y, 392);
        ...
        private static Button CreateSidebarNavigationButton(string text, string icon, int y)
        {
            ...
            button.Tag = text;
            button.SetBounds(10, y, 144, 34);
            button.Font = SettingsBodyFont(8.2F, FontStyle.Bold);
        ...
        private static Button CreateSilenceActionButton(string text, Point location)
        {
            ...
            button.Font = SettingsBodyFont(8.5F, FontStyle.Bold);
            button.Cursor = Cursors.Hand;
            return button;
        }
