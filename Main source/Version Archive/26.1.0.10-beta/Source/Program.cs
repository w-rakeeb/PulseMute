...
namespace PulseMute
{
    ...
    internal sealed partial class MainForm : Form
    {
        ...
        private Color customSettingsSidebarColor = Color.FromArgb(28, 33, 40);
        ...
        {
            return customColorsEnabled ? customSettingsSidebarColor : ThemeSurfaceColor();
        }
        ...
        private void EnsureCustomColorsInitialized()
        {
            ...
            customSettingsSidebarColor = ThemeSurfaceColor();
        ...
        private static string EditionVersionText()
        {
            ...
            return "PulseMute Beta 26.1.0.10-beta";
        }
