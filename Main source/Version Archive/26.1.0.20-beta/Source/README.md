...
PulseMute Beta 26.1.0.20-beta is the active development and validation channel.
...
- Five distinctly shaped mute controls: Classic circle, Studio capsule, Wave pill, Diamond PTT, and Broadcast bubble.
...
- Full-resolution `1254 x 1254` master artwork for the Settings logo.
