...
- Offers Classic circle, Studio capsule, Wave pill, Diamond PTT, and Broadcast bubble mute controls.
...
- Uses individually shaped mute controls instead of repeating one outer tile.
