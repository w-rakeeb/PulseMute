    ...
    internal sealed class MainForm : Form
    {
        ...
        private void ShowSettingsV15()
        {
            using (Form dialog = new Form())
            {
                ...
                scrollPanel.AutoScrollMinSize = new Size(0, 590);
                ...
                Action applyDialogTheme = delegate
                {
                    ...
                    foreach (Label label in new Label[] { heading, autoLabel, taskbarLabel, rememberLabel, dualHotkeyLabel, appearanceLabel, customizationLabel, controllerLabel, microphoneLabel })
                        label.ForeColor = foreground;
                    versionLabel.ForeColor = secondary;

                    foreach (Label state in new Label[] { autoState, taskbarState, rememberState, dualHotkeyState, appearanceState, customizationState, controllerState })
                    ...
                    foreach (ToggleSwitch toggle in new ToggleSwitch[] { autoToggle, taskbarToggle, rememberToggle, dualHotkeyToggle, appearanceToggle })
                    {
                    ...
                    foreach (Panel separator in new Panel[] { separatorOne, separatorTwo, separatorThree, separatorFour, footerSeparator })
                ...
                foreach (Control control in new Control[]
                {
                    ...
                    microphoneLabel, microphoneBox, soundSettingsButton
                })
        ...
        private static string EditionVersionText()
        {
            ...
            return "PulseMute Main 26.1.0.3-stable";
        }
