...
PulseMute `26.1.0.9-stable` is the active daily-use Stable channel.
...
- Friendly `No microphone detected` state with no raw Windows error dialog.
- Automatic fallback to a Windows default input when a saved microphone is disconnected.
