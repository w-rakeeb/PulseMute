...
Current version: `26.1.0.7-stable`
...
- PulseMute Main now uses the supplied circular muted-microphone identity everywhere, defaults to Red/green mic, and retains Stable-specific identity and clean settings.
