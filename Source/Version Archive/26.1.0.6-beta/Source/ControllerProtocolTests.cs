...
namespace PulseMute
{
    internal static class ControllerProtocolTests
    {
        ...
        private static void TestArchivedVersionDiscovery()
        {
            ...
            Assert(versions.Count >= 16, "Expected the Beta snapshots and legacy releases in the version picker.");
        ...
        {
            Assert(NotificationSoundEngine.Presets.Length >= 4, "Expected at least four notification sound styles.");
