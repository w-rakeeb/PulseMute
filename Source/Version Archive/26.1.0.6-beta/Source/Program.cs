...
namespace PulseMute
{
    ...
    internal sealed partial class MainForm : Form
    {
        ...
        private static string EditionVersionText()
        {
            ...
            return "PulseMute Beta 26.1.0.6-beta";
        }
        ...
        private void ToggleMute()
        {
            try
            {
                ...
                if (soundFeedbackEnabled)
                    notificationSound.Play(soundPreset, next);
            }
            catch (Exception ex)
            {
    ...
    internal sealed class NotificationSoundEngine : IDisposable
    {
        ...
        private static readonly string[] PresetNames = { DefaultPreset, "Digital", "Click", "Pulse" };
        ...
        public void Play(string preset, bool muted)
        {
            try
            {
                DisposePlayer();
                stream = new MemoryStream(CreateWaveData(preset, muted), false);
        ...
        internal static byte[] CreateWaveData(string preset, bool muted)
        {
            ...
            double duration = preset == "Pulse" ? 0.28 : preset == "Soft Chime" ? 0.24 : preset == "Digital" ? 0.18 : 0.11;
            ...
            for (int i = 0; i < sampleCount; i++)
            {
                ...
                double volume = preset == "Click" ? 0.22 : 0.18;
