...
PulseMute Beta 26.1.0.18-beta is the active development and validation channel.
...
- Minimal `600 x 460` Settings window that opens beside the main interface.
...
- Five selectable mute-control visuals: Classic circle, Microphone tile, Wave badge, Shield mic, and Signal hex.
