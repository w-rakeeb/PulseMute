...
PulseMute Beta 26.1.0.13-beta is the active development and validation channel.
...
- Bottom hotkey strip below the creator line with a Developer show/hide option.
