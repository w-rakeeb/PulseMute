...
namespace PulseMute
{
    internal static class ControllerProtocolTests
    {
        ...
        private static void TestInstanceIsolation()
        {
            ...
            string previousReleaseConfig = MainForm.ConfigPathForRelease(betaPath, appData, "Beta", "26.1.0.19-beta");
            string currentReleaseConfig = MainForm.ConfigPathForRelease(betaPath, appData, "Beta", "26.1.0.20-beta");
            ...
            Assert(MainForm.ReleaseSettingsIdentity().IndexOf("Beta-26_1_0_20-beta", StringComparison.OrdinalIgnoreCase) >= 0, "Current Beta release identity is invalid.");
        }
        ...
        private static void TestArchivedVersionDiscovery()
        {
            ...
            Assert(versions.Count >= 29, "Expected the Beta snapshots and legacy releases in the version picker.");
        ...
        private static void TestNativeSettingsDesign()
        {
            ...
            Assert(source.IndexOf("26.1.0.20-beta", StringComparison.Ordinal) >= 0, "Settings version label is stale.");
            ...
            Assert(source.IndexOf("Studio capsule", StringComparison.Ordinal) >= 0 && source.IndexOf("Wave pill", StringComparison.Ordinal) >= 0, "Distinct capsule mute visuals are missing.");
            Assert(source.IndexOf("Diamond PTT", StringComparison.Ordinal) >= 0 && source.IndexOf("Broadcast bubble", StringComparison.Ordinal) >= 0, "Distinct PTT and broadcast visuals are missing.");
