...
namespace PulseMute
{
    ...
    internal sealed partial class MainForm : Form
    {
        ...
        private static string EditionVersionText()
        {
            ...
            return "PulseMute Main 26.1.0.4-stable";
        }
        ...
        private static bool IsAutoStartEnabled()
        {
            ...
            {
                return key != null && key.GetValue("PulseMuteMainAutoStart") != null;
            }
        }
        ...
        private static void SetAutoStartEnabled(bool enabled)
        {
            using (RegistryKey key = Registry.CurrentUser.CreateSubKey(@"Software\Microsoft\Windows\CurrentVersion\Run"))
            {
                ...
                if (enabled)
                    key.SetValue("PulseMuteMainAutoStart", "\"" + Application.ExecutablePath + "\"");
                else
                    key.DeleteValue("PulseMuteMainAutoStart", false);
            }
        }

        private static string ConfigPath()
        {
            return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "PulseMute", "Main", "settings.txt");
        }
        ...
        internal static List<ArchivedVersionInfo> DiscoverArchivedVersions(string startupPath)
        {
            ...
            string stableArchive = Path.Combine(startupPath, "Main source", "Version Archive");
            AddArchivedVersionFolders(stableArchive, "Stable ", versions, seenPaths);
        ...
        private static string ArchivedVersionDetails(string name)
        {
            ...
            if (name == "Stable 26.1.0.3-stable") return "Added compact hotkey cards, Dual Hotkey mode, mouse support, and improved scaling.";
