...
namespace PulseMute
{
    ...
    internal sealed partial class MainForm : Form
    {
        ...
        private void ShowSettingsV15Legacy()
        {
            using (Form dialog = new Form())
            {
                ...
                Action applyDialogTheme = delegate
                {
                    ...
                    hotkeyStripState.Text = hotkeyStripToggle.Checked ? "Visible in bottom toolbar" : "Hidden";
        ...
        private static string EditionVersionText()
        {
            ...
            return "PulseMute Beta 26.1.0.14-beta";
        }
        ...
        private void ApplyResponsiveLayout()
        {
            ...
            SetControlFont(shortcutValueLabel, "Segoe UI Semibold", 8.2f * fontScale, FontStyle.Bold);
            SetControlFont(shortcutTwoValueLabel, "Segoe UI Semibold", 8.2f * fontScale, FontStyle.Bold);
