    ...
    internal sealed class MainForm : Form
    {
        ...
        private void ShowSettingsV15()
        {
            using (Form dialog = new Form())
            {
                ...
                Label developerHeading = CreateSettingsLabel("Developer settings", 20, 600);
                developerHeading.Font = new Font("Segoe UI Semibold", 11F, FontStyle.Bold);

                Label developerModeLabel = CreateSettingsLabel("Developer mode", 20, 640);
                Label developerModeState = CreateSettingsStateLabel(20, 662);
                ToggleSwitch developerModeToggle = CreateToggleSwitch(322, 646, developerModeEnabled);

                Label olderVersionLabel = CreateSettingsLabel("Older version", 20, 704);
                ...
                olderVersionBox.SetBounds(20, 728, 238, 30);
                ...
                Button openVersionButton = CreateSmallButton("Open", new Point(268, 728));
                openVersionButton.Size = new Size(100, 30);

                Label versionsInfoLabel = CreateSettingsLabel("Versions info", 20, 772);
                Label versionInfoText = new Label();
                versionInfoText.AutoSize = false;
                versionInfoText.SetBounds(20, 796, 348, 50);
                ...
                Action applyDialogTheme = delegate
                {
                    ...
                    foreach (Label label in new Label[] { heading, autoLabel, taskbarLabel, rememberLabel, dualHotkeyLabel, appearanceLabel, customizationLabel, controllerLabel, microphoneLabel, developerHeading, developerModeLabel, olderVersionLabel, versionsInfoLabel })
                        label.ForeColor = foreground;
                    versionLabel.ForeColor = secondary;

                    foreach (Label state in new Label[] { autoState, taskbarState, rememberState, dualHotkeyState, appearanceState, customizationState, controllerState, developerModeState })
                    ...
                    foreach (ToggleSwitch toggle in new ToggleSwitch[] { autoToggle, taskbarToggle, rememberToggle, dualHotkeyToggle, appearanceToggle, developerModeToggle })
                    {
                    ...
                    foreach (Panel separator in new Panel[] { separatorOne, separatorTwo, separatorThree, separatorFour, separatorFive, footerSeparator })
        ...
        private static string EditionVersionText()
        {
            ...
            return "PulseMute Beta 26.1.0.4-beta";
        }
