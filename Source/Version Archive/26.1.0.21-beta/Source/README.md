...
PulseMute Beta 26.1.0.21-beta is the active development and validation channel.
...
- Five selectable mute controls: Classic circle, Microphone tile, Wave badge, Record button, and Power ring.
