    ...
    internal sealed partial class MainForm
    {
        private void ShowSettingsV15()
        {
            using (Form dialog = new BufferedSettingsForm())
            {
                ...
                string[] muteDesigns = { "Classic circle", "Microphone tile", "Wave badge", "Record button", "Power ring" };
                ...
                aboutVersion.Text = "Version 26.1.0.5-stable";
                ...
                ownerLabel.Text = "Owner: w-rakeeb | Stable release channel";
