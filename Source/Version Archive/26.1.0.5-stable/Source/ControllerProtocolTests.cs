...
namespace PulseMute
{
    internal static class ControllerProtocolTests
    {
        ...
        private static void TestInstanceIsolation()
        {
            ...
            string archivedPath = @"D:\PulseMute\Stable\Archive\26.1.0.4-stable\PulseMute Main.exe";
            ...
            string previousReleaseConfig = MainForm.ConfigPathForRelease(stablePath, appData, "Stable", "26.1.0.4-stable");
            string currentReleaseConfig = MainForm.ConfigPathForRelease(stablePath, appData, "Stable", "26.1.0.5-stable");
            ...
            Assert(MainForm.ReleaseSettingsIdentity().IndexOf("Stable-26_1_0_5-stable", StringComparison.OrdinalIgnoreCase) >= 0, "Current Stable release identity is invalid.");
        }
        ...
        private static void TestArchivedVersionDiscovery()
        {
            ...
            Assert(versions.Count >= 15, "Expected Stable snapshots and legacy releases in the version picker.");
        ...
        private static void TestNativeSettingsDesign()
        {
            ...
            Assert(source.IndexOf("26.1.0.5-stable", StringComparison.Ordinal) >= 0, "Settings version label is stale.");
        ...
        private static void TestProfessionalLogoResource()
        {
            ...
            {
                Assert(logo.Width == 1254 && logo.Height == 1254, "Full-resolution About logo resource dimensions are invalid.");
            }
        }
