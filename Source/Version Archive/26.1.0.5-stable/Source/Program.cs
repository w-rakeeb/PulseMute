...
namespace PulseMute
{
    ...
    internal sealed partial class MainForm : Form
    {
        ...
        private const string ReleaseVersion = "26.1.0.5-stable";
        ...
        private static string ArchivedVersionDetails(string name)
        {
            ...
            if (name == "Stable 26.1.0.3-stable") return "Added mouse hotkeys, dual-hotkey controls, responsive scaling, and the approved Stable interface.";
            if (name == "Stable 26.1.0.4-stable") return "Promoted sidebar Settings, sound feedback, full logo branding, and the legacy-interface fallback.";
