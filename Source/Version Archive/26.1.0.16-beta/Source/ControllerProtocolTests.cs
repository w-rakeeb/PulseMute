...
namespace PulseMute
{
    internal static class ControllerProtocolTests
    {
        ...
        private static void TestSettingsPlacement()
        {
            ...
            System.Drawing.Size settingsSize = new System.Drawing.Size(680, 520);
        ...
        private static void TestArchivedVersionDiscovery()
        {
            ...
            Assert(versions.Count >= 25, "Expected the Beta snapshots and legacy releases in the version picker.");
        ...
        private static void TestNativeSettingsDesign()
        {
            ...
            Assert(source.IndexOf("ClientSize = new Size(680, 520)", StringComparison.Ordinal) >= 0, "Compact Settings size is missing.");
            Assert(source.IndexOf("MinimumSize = new Size(620, 460)", StringComparison.Ordinal) >= 0, "Compact Settings minimum size is missing.");
            ...
            Assert(source.IndexOf("26.1.0.16-beta", StringComparison.Ordinal) >= 0, "Settings version label is stale.");
